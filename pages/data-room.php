...
<body>
    ...
    <section class="hj-product-detail-wrap">
        <article class="hj-product-detail">
            <section class="hj-product-detail-button">
                <ul>
                    <li>
                        <a href="./smartpad" onClick="window.open(this.href, '', 'width=700, height=800'); return false;">
                            <button>
                                <span>버튼1</span>
                            </button>
                        </a>
            ...
            <section class="hj-product-content-wrap">
                <div class="hj-product-image smartpad"></div>
            </section>
        </article>
    </section>
