        ...
        <article class="hj-product-detail">
            <section class="hj-product-content-wrap">
                ...
                <ul id="hjPageSlideButton" class="hj-page-slide-button slick-dots">
                        <li class="hj-active"><button>악세서리</button></li>
                    ...
                    <ul id="hjPageInSlideWrap" class="hj-page-in-slide-wrap product-wrap accessories-wrap">
                        <li class="hj-page-detail-image dtc-133"></li>
                        <li class="hj-page-detail-image dtc-133-button-01">
                            <img src="../../images/products/dtc-133/와콤원_온라인상세페이지_non creative_20210118.jpg" alt="악세서리">
                        </li>
